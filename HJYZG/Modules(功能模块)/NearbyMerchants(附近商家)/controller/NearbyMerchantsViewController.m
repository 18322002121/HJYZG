...
@interface NearbyMerchantsViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,PYSearchViewControllerDelegate>
...
static NSString *const nearbyMerchantsCell = @"NearbyMerchantsCell";
