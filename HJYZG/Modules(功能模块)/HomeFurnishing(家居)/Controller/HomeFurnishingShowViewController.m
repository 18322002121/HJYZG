//
//  HomeFurnishingShowViewController.m
//  HJYZG
//
//  Created by HCY on 2018/8/24.
...
@interface HomeFurnishingShowViewController ()<PYSearchViewControllerDelegate,ZJScrollPageViewDelegate>
...
@implementation HomeFurnishingShowViewController
...
- (UIViewController<ZJScrollPageViewChildVcDelegate> *)childViewController:(UIViewController<ZJScrollPageViewChildVcDelegate> *)reuseViewController forIndex:(NSInteger)index {
    ...
    if (!childVc) {
        childVc = [[HomeFurnishingShowChildViewController alloc] init];
    }
    return childVc;
}
